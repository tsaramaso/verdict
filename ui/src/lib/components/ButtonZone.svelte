...
<div class="button-zone">
	{#if showTestifyFirst}
		<button class="btn btn--primary" onclick={onTestifyFirst}> 🎤 TESTIMONY </button>
		<button class="btn btn--secondary" onclick={onSkip}> PASS </button>
	{:else if showTestifyCross}
		<button class="btn btn--primary" onclick={onTestifyCross}> 🎤 CROSS-EXAMINE </button>
		<button class="btn btn--secondary" onclick={onSkip}> PASS </button>
	{:else if showChallenge}
		<button class="btn btn--primary" onclick={onChallenge}> ⚔️ CHALLENGE </button>
		<button class="btn btn--secondary" onclick={onSkip}> PASS </button>
	{:else if showPlea}
		<button class="btn btn--primary" onclick={onPlea}> 🙏 TAKE PLEA </button>
		<button class="btn btn--secondary" onclick={onPleaDecline}> DECLINE </button>
	{:else if showSkip}
		<button class="btn btn--secondary" onclick={onSkip}> SKIP / PASS </button>
	{/if}
</div>
