 ...
 */
export const ACTIVE_PLAYER_PHASES = new Set([GamePhase.DRAWING, GamePhase.AWAITING_ACTION]);
 ...
 */
export const AUTO_ADVANCE_PHASES = new Set([GamePhase.TURN_START, GamePhase.ROUND_OVER]);
